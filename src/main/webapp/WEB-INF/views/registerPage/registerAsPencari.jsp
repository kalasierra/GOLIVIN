        ...
        <div class="container-fluid cont_nav" style="height: 84px;">
            <div class="row">
                <div class="col-4 my-2">
                        <img src="/aset/logo.png" alt="" style="margin-left: 295px; margin-top: 10px;">
                </div>
                <div class="col-4">
                    <p>&nbsp;</p>
                </div>
            ...
            <div class="row justify-content-center align-item-center ">
                ...
                <div class="col-5">
                    <div id="hasAcc" class="col-10 form-text">
                        <h2 class=""><b><a href='${pageContext.request.contextPath}/homepage2' class="btn btn-link no-border" style="font-size: 20px;" >Home</a></b></h2>
                    </div>
                    </h2>
                </div>
            </div>
