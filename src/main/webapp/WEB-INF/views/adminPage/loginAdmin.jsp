            ...
            <form>
                <div class="login1">
                    <div class="mb-3 my-4">
                        ...
                        <input type="email" class="form-control" id="Email" style="width: 500px;">
                    </div>
                    <div class="mb-3">
                        <label for="pass" class="form-label">Kata Sandi</label>
                        <input type="password" class="form-control" id="pass" placeholder="Minimal 8 karakter" style="width: 500px;">
                    </div>
